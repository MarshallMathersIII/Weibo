package com.eminem.weibo.constants;
...
//            + "follow_app_official_microblog," + "invitation_write";
    ...
    /**
     * 使用第三方微博客户端weico登陆突破接口限制，参数均为weico提供
     */
    String APP_KEY = "211160679";
    String REDIRECT_URL = "http://oauth.weico.cc";
    ...
    String AppSecret = "1e6e33db08f9192306c4afa0a61ad56c";
    String PackageName = "com.eico.weico";
}
